...
import { MapPin, Briefcase, GraduationCap, Award, Languages, ArrowRight } from "lucide-react";
    ...
    <PageWrapper>
      <div className="py-12 sm:py-16 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            title="About Me"
            subtitle="Tech Lead & AI Engineer based in Hong Kong"
          />
                  ...
                  <div className="flex flex-wrap gap-3">
                    {certifications.slice(0, 3).map((cert) => (
                      <motion.div
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-800/50 border border-zinc-700/50 hover:border-purple-500/30 transition-all"
                      >
